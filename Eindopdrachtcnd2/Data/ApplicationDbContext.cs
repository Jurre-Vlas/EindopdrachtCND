...
namespace Eindopdrachtcnd2.Data
{
    public class ApplicationDbContext : IdentityDbContext<User>
    {
        ...
        public DbSet<CardTaskUser> CardTaskUsers { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasMany(u => u.CardTaskUsers)
                    .WithOne(ctu => ctu.User)
            ...
            modelBuilder.Entity<CardTask>(entity =>
            {
                ...
                entity.HasMany(c => c.CardTaskUsers)
                    .WithOne(ctu => ctu.CardTask)
                    .HasForeignKey(ctu => ctu.CardTaskId);
            });

            modelBuilder.Entity<CardUser>()
                .HasKey(cu => new { cu.CardId, cu.UserId });

            modelBuilder.Entity<CardTaskUser>()
                .HasKey(ctu => new { ctu.CardTaskId, ctu.UserId });
        }
        private static void SeedRoles(ModelBuilder modelbuilder)
        {
            modelbuilder.Entity<IdentityRole>().HasData(
                               new IdentityRole() { Name = "Admin", ConcurrencyStamp = "1", NormalizedName = "Admin" },
                               new IdentityRole() { Name = "GroupAdmin", ConcurrencyStamp = "2", NormalizedName = "MindWizeAdmin" },
                               new IdentityRole() { Name = "User", ConcurrencyStamp = "3", NormalizedName = "InterMailAmin" },
                               new IdentityRole() { Name = "NewUser", ConcurrencyStamp = "4", NormalizedName = "NewUser" }
        );
        }
    }
}
